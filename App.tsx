...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // The app is considered "ready" after the initial render cycle.
    // We use requestAnimationFrame to ensure we wait for the browser to be
    // ready for updates before removing the loading screen.
    const frame = requestAnimationFrame(() => setIsAppReady(true));
